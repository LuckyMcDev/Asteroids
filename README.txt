...
This is the readme for Asteroids, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Asteroids) > Ok.
...
- To run the project find Asteroids.java (which will be in under src/main/java/net/me) and right click > Run 'Asteroids'
